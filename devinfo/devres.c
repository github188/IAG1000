...
#define         AUDIO_DEC0_KEY          0x51000          //音频解码器0的输入共享缓冲池key
#define         AUDIO_DEC1_KEY          0x51001          //音频解码器0的输入共享缓冲池key
#define         AUDIO_DEC2_KEY          0x51002          //音频解码器0的输入共享缓冲池key
#define         AUDIO_DEC3_KEY          0x51003          //音频解码器0的输入共享缓冲池key
